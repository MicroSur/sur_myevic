...
__string__ String_Profile5      [] = { 0xBC, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0 }; //section start from the end in bin ( for vtcfont editor )
__string__ String_Profile4      [] = { 0xBC, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0 };
__string__ String_Profile3      [] = { 0xBC, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0 };
__string__ String_Profile2      [] = { 0xBC, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0 };
__string__ String_Profile1      [] = { 0xBC, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0 };