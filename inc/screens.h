...
extern const uint8_t String_OffMod[];
extern const uint8_t String_Sleep[];
extern const uint8_t String_Mode[];
extern const uint8_t String_Low[];
extern const uint8_t String_Off[];
extern const uint8_t String_Lock[];
extern const uint8_t String_UnLock[];
extern const uint8_t String_Protect[];
...
extern const uint8_t String_TEMP[];
//extern const uint8_t String_TCRSet[]; //TCR
...
extern const uint8_t String_VVLite[];
...
extern const uint8_t String_Set[];
...
extern const uint8_t String_PwrLo[];
