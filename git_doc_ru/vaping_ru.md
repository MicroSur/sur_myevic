...
* __HoldFi ( запрет парения )__
    ...
    Off - выключение работы функции.  
    Во время запрета парения в верхней строке будет отображаться оставшееся время запрета. При этом регулировка этого времени в меню запрещена и парить мод не даст - перепар закончен, отложите мод.
